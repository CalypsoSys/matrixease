...
namespace MatrixEase.Web.Middleware
{
    public class AccessLogMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            {
                stopwatch.Stop();
                FileLogWriter.WriteLine(_settings.GetAccessLogPath(), BuildLogLine(context, stopwatch.ElapsedMilliseconds));
            }
        }

        public static string BuildLogLine(HttpContext context, long elapsedMilliseconds)
        {
