...
var	_minW = 100, // The exact value get's calculated
	...
	*/
	...
	_init = function(id, callback) {
		...
		_buttons = _dialog.querySelectorAll('.buttonset button');  // Ensure to get minimal width
		...
		_dialog.style.left = ((window.innerWidth - _dialog.clientWidth) - 32) + 'px';
		_dialog.style.top = ((window.innerHeight - _dialog.clientHeight) - 32) + 'px';
